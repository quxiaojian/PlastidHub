...
=head1 NAME
    ...
    generate_non-interleaved_v1.pl version 1.0
...
=head1 DESCRIPTION
    ...
    generate one-line fasta sequence from multiple lines of fasta sequence

=head1 SYNOPSIS

    generate_non-interleaved_v1.pl -i -o
    Copyright (C) 2025 Xiao-Jian Qu
    Please contact <quxiaojian@sdnu.edu.cn>, if you have any bugs or questions.

    [-h -help]         help information.
    [-i -input]        required: (default: input) input directory containing interleaved .fasta file.
